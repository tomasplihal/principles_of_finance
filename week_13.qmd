...
1. **Provozní riziko** $\rightarrow$ provoz firmy (např. selhání dodavatelů,
...
například akcie, dluhopisy, komodity, měnové kurzy, úrokové sazby a další. Specifikují
parametry transakce, která proběhne v budoucnosti.
:::
...
čímž dosáhne zisku (po odečtení prémie). Pokud cena klesne pod 55 USD, investor opci
...
uplatnit opci a prodat akcie za 95 USD, čímž se vyhne ztrátě a přijde jen o zaplacenou
prémii. Pokud cena zůstane nad 95 USD, opci neuplatní a ztrácí pouze prémii 3 USD.
:::
